      ...
      <Box className={classes.mainCard}>
        ...
        >
          <Typography variant="h6">
            ...
            {timeLeft.hours ? timeLeft.hours && timeLeft.hours : "00"}h:
            {timeLeft.minutes ? timeLeft.minutes && timeLeft.minutes : "00"}m :
            {timeLeft.seconds ? timeLeft.seconds && timeLeft.seconds : "00"}s
          </Typography>
