...
export default function PawsomeCard(props) {
  ...
  return (
    <Box className={classes.pawsomeCardBox}>
      <Box className="albumboxcard" style={{ width: "100%" }}>
        ...
        ></div>
        <img src="images/line.png" alt="image" className="pawsomelineBorder" />
        ...
        <Box display="flex" alignItems="center">
          ...
          <Box
            ...
            // }}
          ></Box>
          <Box className="displaySpacebetween pawsomeLeftBox">
            <Box
            //   onClick={() => {
            //     history.push({
            //       pathname: "/collection-details",
            ...
            >
              ...
              <Box align="center" position="relative" zIndex="9">
                {/* <Typography variant="h6" color="primary"> */}
                <img src="images/qi.svg" alt="Vector Image" width="31px" />
                {/* &nbsp;&nbsp; */}
                {data?.price}
                {/* </Typography> */}
              </Box>
