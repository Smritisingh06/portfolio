...
const TableHeading = [
  ...
  { id: "Firstname", label: "First Name", align: "left", minWidth: "160px" },
  { id: "Lastname", label: "Last Name", align: "left", minWidth: "160px" },
  // { id: "Username", label: "User Name", align: "left", minWidth: "160px" },
  { id: "IBIName", label: "IBI Name", align: "left", minWidth: "160px" },
  { id: "IBIID", label: "IBI ID", align: "left", minWidth: "160px" },
  {
    id: "walletAddress",
...
export default function Admin() {
  ...
  const particularPermition = user?.permissions?.userManagement;
  let isRead =
    ...
    try {
      ...
      if (res.data.statusCode === 200) {
        if (res.data.result.status === "ACTIVE") {
          ...
          toast.success("User has been blocked by admin");
        }
        getuserListHandler();
      }
    } catch (error) {
                ...
                userList.map((row, index) => {
                  return (
                    <TableRow key={index} className={classes.tablesection}>
                      ...
                      >
                        {row.kycFirstName ? row.kycFirstName : "----"}
                      </TableCell>
                      <TableCell
                        align="left"
                        style={{
