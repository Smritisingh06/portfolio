      ...
      <Container maxWidth="lg">
        ...
        <Formik
          ...
          validationSchema={yep.object().shape({
            ...
            title: yep.string().required('Please enter first name').max(36,"Title should not exceed more than 36 character"),
            description: yep.string().required('Please enter message field').max(300,"Message should not exceed more than 300 character"),
            url: yep
        ...
        >
          {({
            ...
            <form onSubmit={handleSubmit}>
              <Paper elevation={2} className={classes.maintext}>
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} sm={12} md={6}>
                    <Box>
                      <Typography variant="body2" color="primary">
                        Title
                        <span style={{ color: 'rgb(255, 125, 104)' }}>*</span>
                      </Typography>
                      <TextField
                        id="outlined-basic"
                        variant="outlined"
