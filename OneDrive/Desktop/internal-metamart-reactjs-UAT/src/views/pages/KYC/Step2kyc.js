...
export default function Step2kyc({
  ...
  const [notAllow2, setNotAllow2] = useState(false);
          ...
          documents != "0" ? (
            <>
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  <Typography variant="body1">
                    Upload File <span style={{ color: "#EB5A2C" }}>*</span>
                  </Typography>
                  <Typography
                    variant="body1"
                    style={{
                  ...
                  {isSumbit && profileImage643 === "" && !notAllow1 && (
                    <FormHelperText error>
                ...
                {documents !== "passport" && (
                  <Grid item xs={12} sm={6}>
                    ...
                    {isSumbit && profileImage64 === "" && !notAllow2 && (
                      <FormHelperText error>
